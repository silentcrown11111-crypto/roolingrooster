...
window.RR_MENU = {
  ...
  categories: [
    ...
    },
    {
      ...
      image: 'assets/products/tower-burger.webp',
      items: [
        ...
        { name: 'Tower Burger With Cheese', price: 500, image: 'assets/products/tower-burger.webp', star: true },
  ...
  deals: [
    { n: 1, title: 'Deal 1', persons: '1 Person', price: 600,
      includes: ['1 Zinger Burger', '1 Chicken Piece', 'Plain Fries'], image: 'assets/products/tower-burger.webp' },
    ...
    { n: 3, title: 'Deal 3', persons: '3 Persons', price: 1700,
      includes: ['3 Zinger Burgers', '10 Pieces BBQ Wings', 'Mayo Garlic Fries'], image: 'assets/products/tower-burger.webp' },
